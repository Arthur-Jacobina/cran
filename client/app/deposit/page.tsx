...
export default function Home() {
  ...
  const contractAddress = '0x99640b1F67C68C0349F7f7cc15E116a54743fE0C';
  const { data: hash, error, isPending, writeContract } = useWriteContract();

  async function payDate() {
    writeContract({
      address: contractAddress,
      abi,
      functionName: 'pay4Date',
      args: [BigInt('10')],
    });
  }
                ...
                <div className="bg-white border border-gray-200 rounded-3xl shadow-lg overflow-hidden">
                  ...
                  <div className="p-4 border-b border-gray-100">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Button
                        variant="ghost"
                        className="rounded-full h-10 gap-1 bg-gray-100 hover:bg-gray-200 font-medium"
                      >
                    ...
                    <div className="text-sm text-gray-500 mt-1">
                      {(selectedFlowers * 0.001).toFixed(3)} ETH ($
                      {selectedFlowers * 5})
                    </div>
                  </div>
                  ...
                  <div className="p-4 pt-0">
                    <Button
                      className="w-full py-6 text-lg font-medium rounded-2xl bg-pink-500 hover:bg-pink-600"
                      onClick={() => {
                        payDate();
                        console.log(hash);
                      }}
                      disabled={isPending}
                    >
                      {isPending ? 'Processing...' : 'Pay for Date'}
                    </Button>
